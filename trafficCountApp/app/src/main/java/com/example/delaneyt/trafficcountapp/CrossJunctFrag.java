 ...
 */
public class CrossJunctFrag extends Fragment implements Button.OnClickListener {

    /**
     * Debug Tag for use logging debug output to LogCat
     */
    private final String TAG = "CrossJunctFrag";
...
//    MySQLiteHelper myTrafficSurveysDb = new MySQLiteHelper(getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_cross_junct, container, false);
