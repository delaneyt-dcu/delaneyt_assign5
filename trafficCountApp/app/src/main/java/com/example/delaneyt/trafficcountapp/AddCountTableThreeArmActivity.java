...
/**
 * Class which counts traffic at a 3-arm junction and adds this data to a database
 *
 * <p> This class allows the user to count traffic at a 3-arm junction and add this data to a
 ...
 */
public class AddCountTableThreeArmActivity extends AppCompatActivity {

    /**
     * Debug Tag for use logging debug output to LogCat
     */
    private final String TAG = "AddCountTableThreeArmActivity";
    ...
    ImageButton m_BtnAtoB, m_BtnAtoC, m_BtnBtoA, m_BtnBtoC, m_BtnCtoA, m_BtnCtoB;
    TextView m_TextViewAtoBVehs, m_TextViewAtoCVehs, m_TextViewBtoAVehs, m_TextViewBtoCVehs,
            m_TextViewCtoAVehs, m_TextViewCtoBVehs, textViewTime;
    ...
    String mArmAName, mArmBName,mArmCName;
     ...
     * No return
     */
    public void updateTextView(String mArmAName, String mArmBName, String mArmCName) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       m_BtnResetCountData = (Button) findViewById(R.id.button_ResetCountData);
        ...
        mLocationPref = PreferenceManager.getDefaultSharedPreferences(AddCountTableThreeArmActivity.this);
        ...
        updateTextView(mArmAName, mArmBName,mArmCName);
        addData();
        viewData();
        resetCountData();
        ...
        Log.i(TAG, "Total veh updated after Left button short pressed.");
        ...
        // Tag marker for this activity
        Log.i(TAG, "Total veh updated after Left button long pressed.");
    ...
    public void addData() {
        m_BtnAddToDb.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                if (isInserted) {
                                                    Toast.makeText(AddCountTableThreeArmActivity.this, "Data Inserted", Toast.LENGTH_LONG).show();
                                                    // resetCountData();
                                                } else {
                                                    Toast.makeText(AddCountTableThreeArmActivity.this, "Data not Inserted", Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        }
        );}
    ...
    public void viewData() {
        m_BtnViewAllData.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MySQLiteHelperCountTable myTrafficSurveysDb = new MySQLiteHelperCountTable(AddCountTableThreeArmActivity.this);
    ...
    public void showMessage (String title, String Message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddCountTableThreeArmActivity.this);
